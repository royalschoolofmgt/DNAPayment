	...
	if(!empty($email_id) && !empty($key)){
		...
		if (count($result) > 0) {
			...
			if (count($result_c) > 0) {
				...
				alterFile($sellerdb,$email_id,$validation_id,$result[0]['is_test_live']);
			}else{
...
function alterFile($sellerdb,$email_id,$validation_id,$is_test_live){
