$(document).ready(function() {
	var stIntId = setInterval(function() {
		if($("#checkout-payment-continue").length > 0) {
			$("#checkout-payment-continue").before('<div class="247dnapayment"><form id="dnapaymentForm" name="dnapaymet"><input type="hidden" id="247dnakey" value="ImJpZ2lAMjQ3Y29tbWVyY2UuY28udWsi" ><button type="submit" class="" style="background-color: #424242;border-color: #424242;color: #fff;">Pay With DNA</button></form></div>');
